...
import { PM_BASE, pmNavGroups, type PmNavItem } from "@/lib/pm/nav";
    ...
    <>
      ...
      >
        ...
        <div className="flex h-[76px] items-center border-b border-hairline px-4">
          <Link href={`${PM_BASE}/dashboard`} aria-label="Azentra dashboard">
            <Logo
              markOnly={collapsed}
