...
/**
 * Stand-in for an accountant section that has not been built yet, so every rail
 * entry leads somewhere instead of 404-ing. Each one is replaced by its real
 * view as the screens land — a route file at the matching path takes precedence
 * over the catch-all that renders this.
 */
export function AccSectionPlaceholder({
  title,
  subtitle,
}: {
  title: string;
