...
import { TEN_BASE, tenNavItems, type TenNavItem } from "@/lib/ten/nav";
    ...
    <>
      ...
      >
        ...
        <div className="flex h-[76px] items-center border-b border-hairline px-4">
          <Link href={`${TEN_BASE}/dashboard`} aria-label="Azentra home">
            <Logo
              markOnly={collapsed}
