    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          ...
          /* Anchoring to the bell would push a 380px panel off the left of a
             phone — the bell sits well inside the right edge. Below `sm` it
             hangs under the header across the screen instead. */
          className="fixed inset-x-4 top-[80px] z-40 overflow-hidden rounded-xl border border-hairline bg-white shadow-lg sm:absolute sm:inset-x-auto sm:top-full sm:right-0 sm:mt-2 sm:w-[380px]"
        >
